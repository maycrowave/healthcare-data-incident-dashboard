...
def main () -> None:
    ...
    with nav_col1:
        with st.container(border=True):
            ...
            st.page_link("dashboard/pages/About.py", label="See About the Dashboard ->", use_container_width=True)
    ...
    with nav_col2:
        with st.container(border=True):
            ...
            st.page_link("dashboard/pages/Explore.py", label="Explore the Data ->", use_container_width=True)
    ...
    with nav_col3:
        with st.container(border=True):
            ...
            st.page_link("dashboard/pages/Simulator.py", label="Simulate a Breach ->", use_container_width=True)
